# If you were asked to update usage/tracker/account status
...
2. Read that repo's `CLAUDE.md`. It has the account nicknames and the exact
   steps and file format to use.
3. Follow it exactly. Do not ask the user which account it is until you've
   checked that file's account list first.

Do not try to answer this kind of request by editing anything in this repo.
